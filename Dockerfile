...
RUN apt-get install -y git gcc g++ autotools-dev dh-autoreconf cmake cmake-data liblua5.2-dev libglib2.0-dev libxerces-c-dev libpango1.0-dev librsvg2-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev libgstreamer-plugins-good1.0-dev libgtk-3-dev
