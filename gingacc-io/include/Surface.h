...
namespace core {
namespace io {
	class Surface : IOContainer {
		protected:
			void* sur;                          //SurfaceGraphicsWg
			void* parent;                       //Window
			Color* chromaColor;
			int caps;
		...
		public:
			Surface();
			Surface(int w, int h);
			Surface(void* someSurface);         //SurfaceGraphicsWg
			virtual ~Surface();
			void addCaps(int caps);
			void setCaps(int caps);
			int getCaps();
			bool setParent(void* parentWindow); //Window
			void* getParent();                  //Window
			void* getContent();
			void setContent(void* surface);
			void setChromaColor(Color* color);
			...
			void setColor(Color* writeColor);
