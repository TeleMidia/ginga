...
namespace core {
namespace io {
	class VideoProvider : public ContinuousMediaProvider {
		protected:
			void* decoder;

		public:
			VideoProvider(char* mrl);
			...
			void playOver(Surface* surface, bool hasVisual=true);
			void resume(Surface* surface, bool hasVisual=true);
			void pause();
			void stop();
