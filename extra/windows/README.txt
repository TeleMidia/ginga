...
3 - On Inno Setup select ginga_win_deploy_script.iss.
4 - Press the green play arrow to start building.
5 - At the end of the build process the program setup is automatically
started.
