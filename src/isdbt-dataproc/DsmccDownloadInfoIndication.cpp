...
GINGA_DATAPROC_BEGIN
	...
	int DsmccDownloadInfoIndication::processMessage(DsmccMessageHeader* message) {
		FILE* fd;
		int rval;
		...
		if (fd != NULL) {
			...
			clog << "DsmccDownloadInfoIndication::processMessage - Message header error: could not open file ";
	...
	unsigned int DsmccDownloadInfoIndication::getDonwloadId() {
		return downloadId;
	}

	unsigned int DsmccDownloadInfoIndication::getBlockSize() {
		return blockSize;
	}

	unsigned int DsmccDownloadInfoIndication::getNumberOfModules() {
		return numberOfModules;
	}

	void DsmccDownloadInfoIndication::getInfo(map<unsigned int, DsmccModule*>* ocInfo) {
		ocInfo->insert(modules.begin(), modules.end());
	}

	void DsmccDownloadInfoIndication::print() {
