...
int DsmccNPTEndpoint::updateStream() {
...
unsigned int DsmccNPTEndpoint::calculateDescriptorSize() {
	int pos = DsmccMpegDescriptor::calculateDescriptorSize();
	return pos + 14;
}

uint64_t DsmccNPTEndpoint::getStartNPT() {
	return startNPT;
}

uint64_t DsmccNPTEndpoint::getStopNPT() {
	return stopNPT;
}

void DsmccNPTEndpoint::setStartNPT(uint64_t npt) {
	startNPT = npt;
}

void DsmccNPTEndpoint::setStopNPT(uint64_t npt) {
	stopNPT = npt;
}
