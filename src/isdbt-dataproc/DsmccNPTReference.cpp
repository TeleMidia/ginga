...
int DsmccNPTReference::updateStream() {
...
unsigned int DsmccNPTReference::calculateDescriptorSize() {
	int pos = DsmccMpegDescriptor::calculateDescriptorSize();
	return pos + 18;
}

char DsmccNPTReference::getPostDiscontinuityIndicator() {
	return postDiscontinuityIndicator;
}

unsigned char DsmccNPTReference::getContentId() {
	return contentId;
}

uint64_t DsmccNPTReference::getStcRef() {
	return stcRef;
}

uint64_t DsmccNPTReference::getNptRef() {
	return nptRef;
}

short DsmccNPTReference::getScaleNumerator() {
	return scaleNumerator;
}

unsigned short DsmccNPTReference::getScaleDenominator() {
	return scaleDenominator;
}

void DsmccNPTReference::setPostDiscontinuityIndicator(char indicator) {
	postDiscontinuityIndicator = indicator;
}

void DsmccNPTReference::setContentId(unsigned char id) {
	contentId = (id & 0x7F);
}

void DsmccNPTReference::setStcRef(uint64_t stc) {
	stcRef = stc;
}

void DsmccNPTReference::setNptRef(uint64_t npt) {
	nptRef = npt;
}

void DsmccNPTReference::setScaleNumerator(short numerator) {
	scaleNumerator = numerator;
}

void DsmccNPTReference::setScaleDenominator(unsigned short denominator) {
