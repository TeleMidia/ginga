...
public:
  ...
  bool setBottom (double newBottom, bool isPercent);
  bool setHeight (double newHeight, bool isPercent);
  bool setLeft (double newLeft, bool isPercent);
  bool setRight (double newRight, bool isPercent);
  void setTitle (const string &newTitle);
  bool setTop (double newTop, bool isPercent);
  bool setWidth (double newWidth, bool isPercent);
