...
void
ApplicationPlayerAdapter::setNclEditListener (IPlayerListener *listener)
{
...
void
ApplicationPlayerAdapter::checkPlayerSurface (ExecutionObject *obj)
{
...
bool
ApplicationPlayerAdapter::hasPrepared ()
{
  bool presented;
...
bool
ApplicationPlayerAdapter::prepare (ExecutionObject *object,
...
void
ApplicationPlayerAdapter::prepare (FormatterEvent *event)
{
  double duration;
...
bool
ApplicationPlayerAdapter::start ()
{
  ...
  if ((startSuccess) || (objectDevice == 2))
    { // DeviceDomain::CT_ACTIVE
      // clog << "ApplicationPlayerAdapter::play objectDevice" << objectDevice
      // << endl;
...
bool
ApplicationPlayerAdapter::pause ()
{
...
bool
ApplicationPlayerAdapter::resume ()
{
...
bool
ApplicationPlayerAdapter::abort ()
{
  map<string, FormatterEvent *>::iterator i;
  FormatterEvent *event;
...
bool
ApplicationPlayerAdapter::unprepare ()
{
  map<string, FormatterEvent *>::iterator i;
...
void
ApplicationPlayerAdapter::naturalEnd ()
{
  map<string, FormatterEvent *>::iterator i;
  FormatterEvent *event;
...
void
ApplicationPlayerAdapter::updateStatus (short code, string param, short type,
                                        string value)
{
...
void
ApplicationPlayerAdapter::notificationHandler (short code, string param,
...
bool
ApplicationPlayerAdapter::checkEvent (FormatterEvent *event, short type)
{
...
bool
ApplicationPlayerAdapter::startEvent (string anchorId, short type,
                                      string value)
{
...
bool
ApplicationPlayerAdapter::stopEvent (string anchorId, short type, string value)
{
...
bool
ApplicationPlayerAdapter::abortEvent (string anchorId, short type)
{
  FormatterEvent *event;
...
bool
ApplicationPlayerAdapter::pauseEvent (string anchorId, short type)
{
  FormatterEvent *event;
  string cvt_id = anchorId;
...
bool
ApplicationPlayerAdapter::resumeEvent (string anchorId, short type)
{
  FormatterEvent *event;
  string cvt_id = anchorId;
...
void
ApplicationPlayerAdapter::lockEvent ()
{
  Thread::mutexLock (&eventMutex);
}

void
ApplicationPlayerAdapter::unlockEvent ()
{
  Thread::mutexUnlock (&eventMutex);
}

void
ApplicationPlayerAdapter::lockPreparedEvents ()
{
  Thread::mutexLock (&eventsMutex);
}

void
ApplicationPlayerAdapter::unlockPreparedEvents ()
{
