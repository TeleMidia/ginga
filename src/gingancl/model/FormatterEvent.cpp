...
bool
FormatterEvent::hasInstance (FormatterEvent *event, bool remove)
{
...
void
FormatterEvent::addInstance (FormatterEvent *event)
{
  Thread::mutexLock (&iMutex);
...
bool
FormatterEvent::removeInstance (FormatterEvent *event)
{
  set<FormatterEvent *>::iterator i;
  bool inst = false;
...
bool
FormatterEvent::instanceOf (string s)
{
  if (typeSet.empty ())
    {
      return false;
...
bool
FormatterEvent::hasNcmId (FormatterEvent *event, string anchorId)
{
  Anchor *anchor;
  string anchorName = " ";
...
void
FormatterEvent::setEventType (short eventType)
{
  this->eventType = eventType;
}

short
FormatterEvent::getEventType ()
{
  return eventType;
}

void
FormatterEvent::destroyListeners ()
{
...
void
FormatterEvent::setId (string id)
{
  this->id = id;
}

void
FormatterEvent::addEventListener (IEventListener *listener)
{
...
bool
FormatterEvent::containsEventListener (IEventListener *listener)
{
  Thread::mutexLock (&mutex);
...
void
FormatterEvent::removeEventListener (IEventListener *listener)
{
...
short
FormatterEvent::getNewState (short transition)
{
  switch (transition)
    {
...
short
FormatterEvent::getTransition (short newState)
{
...
void
FormatterEvent::setCurrentState (short newState)
{
...
bool
FormatterEvent::changeState (short newState, short transition)
{
  set<IEventListener *>::iterator i;
...
short
FormatterEvent::getCurrentState ()
{
  return currentState;
}

short
FormatterEvent::getPreviousState ()
{
  return previousState;
}

short
FormatterEvent::getTransistion (short previousState, short newState)
{
...
void *
FormatterEvent::getExecutionObject ()
{
  return executionObject;
}

void
FormatterEvent::setExecutionObject (void *object)
{
...
long
FormatterEvent::getOccurrences ()
{
  return occurrences;
}

string
FormatterEvent::getStateName (short state)
{
  switch (state)
    {
    case EventUtil::ST_OCCURRING:
