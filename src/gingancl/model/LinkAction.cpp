...
void
LinkAction::initLinkAction (double delay)
{
...
bool
LinkAction::instanceOf (string s)
{
  if (typeSet.empty ())
    {
      return false;
...
double
LinkAction::getWaitDelay ()
{
  return this->delay;
}

void
LinkAction::setSatisfiedCondition (void *satisfiedCondition)
{
...
void
LinkAction::run (void *satisfiedCondition)
{
  this->satisfiedCondition = satisfiedCondition;
  run ();
}
...
void
LinkAction::setWaitDelay (double delay)
{
  this->delay = delay;
}
...
void
LinkAction::addActionProgressionListener (
...
void
LinkAction::removeActionProgressionListener (
    LinkActionProgressionListener *listener)
{
...
void
LinkAction::notifyProgressionListeners (bool start)
{
  int i, size;
  LinkActionProgressionListener *listener;
