...
bool
ExecutionObject::hasInstance (ExecutionObject *object, bool eraseFromList)
{
                                  ...
                                  ILinkActionListener *seListener)
{
  ...
  initializeExecutionObject (id, node, new CascadingDescriptor (descriptor),
                             handling, seListener);
}
...
void
ExecutionObject::initializeExecutionObject (string id, Node *node,
                                            CascadingDescriptor *descriptor,
                                            bool handling,
                                            ILinkActionListener *seListener)
{
...
void
ExecutionObject::removeParentListenersFromEvent (FormatterEvent *event)
{
...
bool
ExecutionObject::instanceOf (string s)
{
  return (typeSet.find (s) != typeSet.end ());
}

int
ExecutionObject::compareToUsingId (ExecutionObject *object)
{
...
void
ExecutionObject::setMirrorSrc (ExecutionObject *mirrorSrc)
{
...
void
ExecutionObject::addParentObject (void *parentObject, Node *parentNode)
{
...
void
ExecutionObject::addParentObject (Node *node, void *parentObject,
                                  Node *parentNode)
{
...
void
ExecutionObject::removeParentObject (Node *parentNode, void *parentObject)
{
...
void
ExecutionObject::setDescriptor (CascadingDescriptor *cascadingDescriptor)
{
...
int
ExecutionObject::compareTo (ExecutionObject *object)
{
  int ret;
...
int
ExecutionObject::compareToUsingStartTime (ExecutionObject *object)
{
...
FormatterEvent *
ExecutionObject::getEventFromAnchorId (string anchorId)
{
  map<string, FormatterEvent *>::iterator i;
  FormatterEvent *event;
...
FormatterEvent *
ExecutionObject::getEvent (string id)
{
  FormatterEvent *ev;
  lockEvents ();
...
bool
ExecutionObject::hasSampleEvents ()
{
  map<string, FormatterEvent *>::iterator i;
  FormatterEvent *event;
...
set<AnchorEvent *> *
ExecutionObject::getSampleEvents ()
{
...
double
ExecutionObject::getExpectedStartTime ()
{
  return startTime;
}
...
void
ExecutionObject::setStartTime (double t)
{
  startTime = t;
}

void
ExecutionObject::updateEventDurations ()
{
...
void
ExecutionObject::updateEventDuration (PresentationEvent *event)
{
  double duration;
...
void
ExecutionObject::removeNode (Node *node)
{
  Node *parentNode;
  map<Node *, Node *>::iterator i;
  map<Node *, void *>::iterator j;
...
PropertyAnchor *
ExecutionObject::getNCMProperty (string propertyName)
{
...
ExecutionObject::getObjectPerspective ()
{
  return getObjectPerspective (dataObject);
}

vector<ExecutionObject *> *
ExecutionObject::getObjectPerspective (Node *node)
{
...
vector<Node *> *
ExecutionObject::getParentNodes ()
{
  vector<Node *> *parents;
  map<Node *, Node *>::iterator i;
...
bool
ExecutionObject::prepare (FormatterEvent *event, double offsetTime)
{
  int size;
  map<Node *, void *>::iterator i;
  double startTime = 0;
          ...
          while (i != parentTable.end ())
            {
              ...
              mainEvent->addEventListener (
                  (IEventListener *)(CompositeExecutionObject *)i->second);
              ++i;
            }
          unlockParentTable ();
          return true;
...
void
ExecutionObject::timeBaseNaturalEnd (int64_t timeValue, short int transType)
{
...
void
ExecutionObject::updateTransitionTable (double value, IPlayer *player,
                                        short int transType)
{
...
void
ExecutionObject::resetTransitionEvents (short int transType)
{
  transMan->resetTimeIndexByType (transType);
}

void
ExecutionObject::prepareTransitionEvents (short int transType,
                                          double startTime)
{
...
set<double> *
ExecutionObject::getTransitionsValues (short int transType)
{
...
bool
ExecutionObject::setPropertyValue (AttributionEvent *event, string value)
{
...
string
ExecutionObject::getPropertyValue (string param)
{
...
bool
ExecutionObject::selectionEvent (int keyCode, double currentTime)
{
  int selCode;
...
set<int> *
ExecutionObject::getInputEvents ()
{
  set<SelectionEvent *>::iterator i;
  set<int> *evs;
  SelectionEvent *ev;
...
void
ExecutionObject::lockEvents ()
{
  Thread::mutexLock (&mutexEvent);
}

void
ExecutionObject::unlockEvents ()
{
  Thread::mutexUnlock (&mutexEvent);
}

void
ExecutionObject::lockParentTable ()
{
  Thread::mutexLock (&mutexParentTable);
}

void
ExecutionObject::unlockParentTable ()
{
