...
CompositeExecutionObject::CompositeExecutionObject (
    ...
    : ExecutionObject (id, dataObject, handling, seListener)
{
...
CompositeExecutionObject::CompositeExecutionObject (
    string id, Node *dataObject, CascadingDescriptor *descriptor,
...
void
CompositeExecutionObject::initializeCompositeExecutionObject (
    string id, Node *dataObject, CascadingDescriptor *descriptor)
{
...
void
CompositeExecutionObject::suspendLinkEvaluation (bool suspend)
{
  set<FormatterLink *>::iterator i;
...
bool
CompositeExecutionObject::addExecutionObject (ExecutionObject *obj)
{
  string objId;
...
bool
CompositeExecutionObject::containsExecutionObject (string execObjId)
{
...
ExecutionObject *
CompositeExecutionObject::getExecutionObject (string id)
{
  map<string, ExecutionObject *>::iterator i;
...
int
CompositeExecutionObject::getNumExecutionObjects ()
{
  int size = 0;
  ...
  while (i != execObjList.end ())
    {
      ...
      if (childObject->instanceOf ("CompositeExecutionObject"))
        {
          grandChildrenObjects = ((CompositeExecutionObject *)childObject)
...
bool
CompositeExecutionObject::removeExecutionObject (ExecutionObject *obj)
{
  map<string, ExecutionObject *>::iterator i;
...
set<Link *> *
CompositeExecutionObject::getUncompiledLinks ()
{
...
bool
CompositeExecutionObject::containsUncompiledLink (Link *dataLink)
{
  lockSTL ();
...
void
CompositeExecutionObject::removeLinkUncompiled (Link *ncmLink)
{
  set<Link *>::iterator i;
...
void
CompositeExecutionObject::setLinkCompiled (FormatterLink *link)
{
  if (link == NULL)
    {
...
void
CompositeExecutionObject::addNcmLink (Link *ncmLink)
{
  lockSTL ();
...
void
CompositeExecutionObject::removeNcmLink (Link *ncmLink)
{
  bool contains;
  FormatterLink *link;
...
void
CompositeExecutionObject::setAllLinksAsUncompiled (bool isRecursive)
{
  ExecutionObject *childObject;
  map<string, ExecutionObject *>::iterator i;
...
void
CompositeExecutionObject::setParentsAsListeners ()
{
...
void
CompositeExecutionObject::unsetParentsAsListeners ()
{
  map<Node *, void *>::iterator i;
...
void
CompositeExecutionObject::eventStateChanged (void *changedEvent,
                                             short transition,
                                             short previousState)
{
...
short
CompositeExecutionObject::getPriorityType ()
{
  return IEventListener::PT_OBJECT;
}

void
CompositeExecutionObject::linkEvaluationStarted (FormatterCausalLink *link)
{
...
void
CompositeExecutionObject::linkEvaluationFinished (FormatterCausalLink *link,
                                                  bool start)
{
...
bool
CompositeExecutionObject::setPropertyValue (AttributionEvent *event,
                                            string value)
{
...
void
CompositeExecutionObject::checkLinkConditions ()
{
  if (!running)
    {
      Thread::startThread ();
...
void
CompositeExecutionObject::listRunningObjects ()
{
  map<string, ExecutionObject *>::iterator i;
...
void
CompositeExecutionObject::listPendingLinks ()
{
  map<FormatterLink *, int>::iterator i;
  Link *ncmLink;
...
void
CompositeExecutionObject::lockComposite ()
{
  if (!deleting)
    {
...
void
CompositeExecutionObject::unlockComposite ()
{
  if (!deleting)
    {
...
void
CompositeExecutionObject::lockSTL ()
{
  if (!deleting)
    {
...
void
CompositeExecutionObject::unlockSTL ()
{
  if (!deleting)
    {
