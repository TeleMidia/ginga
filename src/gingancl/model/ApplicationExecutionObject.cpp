...
ApplicationExecutionObject::ApplicationExecutionObject (
    string id, Node *node, bool handling, ILinkActionListener *seListener)
    : ExecutionObject (id, node, handling, seListener)
{
...
ApplicationExecutionObject::ApplicationExecutionObject (
    string id, Node *node, CascadingDescriptor *descriptor, bool handling,
    ILinkActionListener *seListener)
    : ExecutionObject (id, node, descriptor, handling, seListener)
{
...
void
ApplicationExecutionObject::initializeApplicationObject ()
{
...
bool
ApplicationExecutionObject::isSleeping ()
{
  map<string, FormatterEvent *>::iterator i;
...
bool
ApplicationExecutionObject::isPaused ()
{
  map<string, FormatterEvent *>::iterator i;
...
FormatterEvent *
ApplicationExecutionObject::getCurrentEvent ()
{
  return currentEvent;
}

bool
ApplicationExecutionObject::hasPreparedEvent (FormatterEvent *event)
{
  bool hasEvents;
  map<string, FormatterEvent *>::iterator i;
...
void
ApplicationExecutionObject::setCurrentEvent (FormatterEvent *event)
{
...
bool
ApplicationExecutionObject::start ()
{
  ContentAnchor *contentAnchor;
...
EventTransition *
ApplicationExecutionObject::getNextTransition ()
{
  if (currentEvent == NULL
...
bool
ApplicationExecutionObject::stop ()
{
  ContentAnchor *contentAnchor;
  double endTime;
...
bool
ApplicationExecutionObject::abort ()
{
...
bool
ApplicationExecutionObject::pause ()
{
  FormatterEvent *ev;
  vector<FormatterEvent *> *evs;
  vector<FormatterEvent *>::iterator i;
...
bool
ApplicationExecutionObject::resume ()
{
  FormatterEvent *event;
  vector<FormatterEvent *> *evs;
  vector<FormatterEvent *>::iterator i;
...
bool
ApplicationExecutionObject::unprepare ()
{
  map<Node *, void *>::iterator i;
...
void
ApplicationExecutionObject::unprepareEvents ()
{
  FormatterEvent *event;
  vector<FormatterEvent *> *evs;
  vector<FormatterEvent *>::iterator i;
...
void
ApplicationExecutionObject::removeEventListeners ()
{
  FormatterEvent *event;
  vector<FormatterEvent *> *evs;
  vector<FormatterEvent *>::iterator i;
...
void
ApplicationExecutionObject::removeParentObject (Node *parentNode,
                                                void *parentObject)
{
...
void
ApplicationExecutionObject::removeParentListenersFromEvent (
    FormatterEvent *event)
{
...
void
ApplicationExecutionObject::lockEvents ()
{
  Thread::mutexLock (&eventsMutex);
}

void
ApplicationExecutionObject::unlockEvents ()
{
