...
FormatterEvent *
LinkSimpleAction::getEvent ()
{
  return event;
}

short
LinkSimpleAction::getType ()
{
  return actionType;
}

void
LinkSimpleAction::setSimpleActionListener (ILinkActionListener *listener)
{
...
vector<LinkAction *> *
LinkSimpleAction::getImplicitRefRoleActions ()
{
