...
GingaScreenID
FormatterLayout::getScreenID ()
{
  return myScreen;
}

LayoutRegion *
FormatterLayout::getDeviceRegion ()
{
  return deviceRegion;
}

void
FormatterLayout::addChild (string objectId, FormatterLayout *child)
{
...
string
FormatterLayout::getBitMapRegionId ()
{
...
LayoutRegion *
FormatterLayout::getNcmRegion (string regionId)
{
  if (deviceRegion != NULL)
    {
...
void
FormatterLayout::printRegionMap ()
{
...
void
FormatterLayout::printObjectMap ()
{
...
void
FormatterLayout::createDeviceRegion (int x, int y, int w, int h)
{
...
ExecutionObject *
FormatterLayout::getObject (int x, int y)
{
  map<string, set<FormatterRegion *> *>::iterator i;
...
void
FormatterLayout::getSortedIds (vector<GingaWindowID> *sortedIds)
{
  map<string, set<FormatterRegion *> *>::iterator i;
  set<FormatterRegion *>::iterator j;
  vector<string>::iterator k;
...
GingaWindowID
FormatterLayout::prepareFormatterRegion (ExecutionObject *object,
...
void
FormatterLayout::sortRegion (string regionId, float cvtIndex, string plan)
{
...
float
FormatterLayout::convertZIndex (int zIndex, string plan)
{
  float planPower = 2.0;
...
void
FormatterLayout::showObject (ExecutionObject *object)
{
  FormatterRegion *region;
...
void
FormatterLayout::hideObject (ExecutionObject *object)
{
...
GingaWindowID
FormatterLayout::addRegionOnMaps (ExecutionObject *object,
                                  FormatterRegion *region,
                                  GingaSurfaceID renderedSurface,
...
ExecutionObject *
FormatterLayout::removeFormatterRegionFromMaps (
...
set<FormatterRegion *> *
FormatterLayout::getFormatterRegionsFromNcmRegion (string regionId)
{
...
void
FormatterLayout::lock ()
{
  Thread::mutexLock (&mutex);
}

void
FormatterLayout::unlock ()
{
