...
short int
EventTransitionManager::getType (PresentationEvent *event)
{
...
vector<EventTransition *> *
EventTransitionManager::getTransitionEvents (short int type)
{
...
void
EventTransitionManager::addEventTransition (EventTransition *transition,
                                            short int type)
{
...
void
EventTransitionManager::removeEventTransition (PresentationEvent *event)
{
...
void
EventTransitionManager::resetTimeIndex ()
{
...
void
EventTransitionManager::resetTimeIndexByType (short int type)
{
  map<short int, int>::iterator i;
...
void
EventTransitionManager::prepare (bool wholeContent, double startTime,
                                 short int type)
{
...
void
EventTransitionManager::start (double offsetTime)
{
  vector<EventTransition *> *transitionEvents;
  EventTransition *transition;
  unsigned int transIx, size;
...
void
EventTransitionManager::stop (double endTime, bool applicationType)
{
  vector<EventTransition *> *transitionEvents;
...
void
EventTransitionManager::abort (double endTime, bool applicationType)
{
  vector<EventTransition *> *transitionEvents;
...
void
EventTransitionManager::addPresentationEvent (PresentationEvent *event)
{
...
void
EventTransitionManager::timeBaseNaturalEnd (int64_t timeValue,
...
set<double> *
EventTransitionManager::getTransitionsValues (short int transType)
{
...
EventTransition *
EventTransitionManager::getNextTransition (FormatterEvent *mainEvent)
{
