  ...
  if (descriptor != NULL)
    {
      ...
      for (i = 0; i < size; i++)
        {
          cascade ((GenericDescriptor *)(((CascadingDescriptor *)descriptor)
                                             ->descriptors[i]));
        }
...
void
CascadingDescriptor::initializeCascadingDescriptor ()
{
...
bool
CascadingDescriptor::instanceOf (string s)
{
  if (typeSet.empty ())
    return false;
  else
...
string
CascadingDescriptor::getId ()
{
  return id;
}

void
CascadingDescriptor::cascadeDescriptor (Descriptor *descriptor)
{
...
bool
CascadingDescriptor::isLastDescriptor (GenericDescriptor *descriptor)
{
...
void
CascadingDescriptor::cascade (GenericDescriptor *descriptor)
{
...
GenericDescriptor *
CascadingDescriptor::getUnsolvedDescriptor (int i)
{
...
CascadingDescriptor::getUnsolvedDescriptors ()
{
...
double
CascadingDescriptor::getExplicitDuration ()
{
  return (this->explicitDuration);
}

bool
CascadingDescriptor::getFreeze ()
{
  return freeze;
}

string
CascadingDescriptor::getPlayerName ()
{
  return playerName;
}

LayoutRegion *
CascadingDescriptor::getRegion ()
{
  return region;
}

LayoutRegion *
CascadingDescriptor::getRegion (void *formatterLayout, void *object)
{
...
FormatterRegion *
CascadingDescriptor::getFormatterRegion ()
{
  return formatterRegion;
}

void
CascadingDescriptor::updateRegion (void *formatterLayout, string name,
                                   string value)
{
...
void
CascadingDescriptor::createDummyRegion (void *formatterLayout,
...
void
CascadingDescriptor::setFormatterLayout (void *formatterLayout)
{
  if (region == NULL)
    {
...
long
CascadingDescriptor::getRepetitions ()
{
  return repetitions;
}

vector<Parameter *> *
CascadingDescriptor::getParameters ()
{
...
string
CascadingDescriptor::getParameterValue (string paramName)
{
...
vector<GenericDescriptor *> *
CascadingDescriptor::getNcmDescriptors ()
{
  return &descriptors;
}

Color *
CascadingDescriptor::getFocusBorderColor ()
{
  return focusBorderColor;
}

double
CascadingDescriptor::getFocusBorderTransparency ()
{
  return focusBorderTransparency;
}

int
CascadingDescriptor::getFocusBorderWidth ()
{
  return focusBorderWidth;
}

string
CascadingDescriptor::getFocusIndex ()
{
  return focusIndex;
}

string
CascadingDescriptor::getFocusSrc ()
{
  return focusSrc;
}

string
CascadingDescriptor::getSelectionSrc ()
{
  return selectionSrc;
}

string
CascadingDescriptor::getMoveDown ()
{
  return moveDown;
}

string
CascadingDescriptor::getMoveLeft ()
{
  return moveLeft;
}

string
CascadingDescriptor::getMoveRight ()
{
  return moveRight;
}

string
CascadingDescriptor::getMoveUp ()
{
  return moveUp;
}

Color *
CascadingDescriptor::getSelBorderColor ()
{
  return selBorderColor;
}

int
CascadingDescriptor::getSelBorderWidth ()
{
  return selBorderWidth;
}

vector<Transition *> *
CascadingDescriptor::getInputTransitions ()
{
  return this->inputTransitions;
}

vector<Transition *> *
CascadingDescriptor::getOutputTransitions ()
{
