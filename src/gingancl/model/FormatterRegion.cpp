...
FormatterRegion::FormatterRegion (string objectId, void *descriptor,
                                  void *layoutManager)
{
  ...
  value = ((CascadingDescriptor *)descriptor)->getParameterValue ("scroll");
...
void
FormatterRegion::initializeNCMRegion ()
{
...
void
FormatterRegion::setRenderedSurface (GingaSurfaceID iSur)
{
  this->renderedSurface = iSur;
}

void
FormatterRegion::setZIndex (int zIndex)
{
  string layoutId;
  float cvtZIndex;
  ...
  if (originalRegion != NULL && layoutManager != NULL)
    {
      ...
      cvtZIndex = ((FormatterLayout *)layoutManager)
...
int
FormatterRegion::getZIndex ()
{
  return zIndex;
}

void
FormatterRegion::setPlan (string plan)
{
  if (this->plan != plan)
    {
      this->plan = plan;
...
string
FormatterRegion::getPlan ()
{
  return plan;
}

void
FormatterRegion::setFocusIndex (string focusIndex)
{
  this->focusIndex = focusIndex;
}

string
FormatterRegion::getFocusIndex ()
{
  if (focusIndex != "")
    {
      return focusIndex;
...
void
FormatterRegion::setMoveUp (string moveUp)
{
  this->moveUp = moveUp;
}

string
FormatterRegion::getMoveUp ()
{
  if (moveUp != "")
    {
      return moveUp;
...
void
FormatterRegion::setMoveDown (string moveDown)
{
  this->moveDown = moveDown;
}

string
FormatterRegion::getMoveDown ()
{
  if (moveDown != "")
    {
      return moveDown;
...
void
FormatterRegion::setMoveLeft (string moveLeft)
{
  this->moveLeft = moveLeft;
}

string
FormatterRegion::getMoveLeft ()
{
  if (moveLeft != "")
    {
      return moveLeft;
...
void
FormatterRegion::setMoveRight (string moveRight)
{
  this->moveRight = moveRight;
}

string
FormatterRegion::getMoveRight ()
{
  if (moveRight != "")
    {
      return moveRight;
...
void
FormatterRegion::setFocusBorderColor (Color *focusBorderColor)
{
  lockFocusInfo ();
...
Color *
FormatterRegion::getFocusBorderColor ()
{
  Color *bColor = NULL;
...
void
FormatterRegion::setFocusBorderWidth (int focusBorderWidth)
{
  this->focusBorderWidth = focusBorderWidth;
}

int
FormatterRegion::getFocusBorderWidth ()
{
...
void
FormatterRegion::setFocusComponentSrc (string focusComponentSrc)
{
  this->focusComponentSrc = focusComponentSrc;
}

string
FormatterRegion::getFocusComponentSrc ()
{
...
void
FormatterRegion::setSelBorderColor (Color *selBorderColor)
{
  lockFocusInfo ();
...
Color *
FormatterRegion::getSelBorderColor ()
{
  Color *sColor = NULL;
...
void
FormatterRegion::setSelBorderWidth (int selBorderWidth)
{
  this->selBorderWidth = selBorderWidth;
}

int
FormatterRegion::getSelBorderWidth ()
{
  if (selBorderWidth != 0)
    {
...
void
FormatterRegion::setSelComponentSrc (string selComponentSrc)
{
  this->selComponentSrc = selComponentSrc;
}

string
FormatterRegion::getSelComponentSrc ()
{
  if (selComponentSrc != "")
    {
...
void *
FormatterRegion::getLayoutManager ()
{
  return layoutManager;
}

GingaWindowID
FormatterRegion::getOutputId ()
{
...
void
FormatterRegion::meetComponent (int width, int height, int prefWidth,
...
void
FormatterRegion::sliceComponent (int width, int height, int prefWidth,
                                 int prefHeight, GingaSurfaceID component)
{
...
void
FormatterRegion::updateCurrentComponentSize ()
{
...
void
FormatterRegion::updateRegionBounds ()
{
  sizeRegion ();
...
bool
FormatterRegion::intersects (int x, int y)
{
  if (ncmRegion != NULL)
    {
...
LayoutRegion *
FormatterRegion::getLayoutRegion ()
{
  return ncmRegion;
}

LayoutRegion *
FormatterRegion::getOriginalRegion ()
{
  return originalRegion;
}

GingaWindowID
FormatterRegion::prepareOutputDisplay (GingaSurfaceID renderedSurface,
                                       float cvtIndex)
{
              ...
              if (transitionType == Transition::TYPE_FADE)
                {
                  ...
                  pthread_create (&threadId_, 0, FormatterRegion::fadeT,
                                  (void *)t);
              ...
              else if (transitionType == Transition::TYPE_BARWIPE)
                {
                  ...
                  pthread_create (&threadId_, 0, FormatterRegion::barWipeT,
                                  (void *)t);
...
void
FormatterRegion::performOutTrans ()
{
  vector<Transition *> *transitions;
  unsigned int i;
  Transition *transition;
...
double
FormatterRegion::getOutTransDur ()
{
  vector<Transition *> *transitions;
  unsigned int i;
  Transition *transition;
...
void
FormatterRegion::setRegionVisibility (bool visible)
{
  lock ();
  if (externHandler)
    {
...
void
FormatterRegion::disposeOutputDisplay ()
{
  if (outputDisplay != 0)
    {
      GingaScreenID screenId
...
void
FormatterRegion::bringChildrenToFront (LayoutRegion *parentRegion)
{
...
void
FormatterRegion::traverseFormatterRegions (LayoutRegion *region,
...
void
FormatterRegion::bringHideWindowToFront (LayoutRegion *baseRegion,
...
void
FormatterRegion::bringSiblingToFront (FormatterRegion *region)
{
...
void
FormatterRegion::setGhostRegion (bool ghost)
{
  lock ();
  if (outputDisplay != 0 && !externHandler)
    {
...
bool
FormatterRegion::isVisible ()
{
  return imVisible;
}

short
FormatterRegion::getFocusState ()
{
  return focusState;
}

bool
FormatterRegion::setSelection (bool selOn)
{
  GingaScreenID screenId;
...
void
FormatterRegion::setFocus (bool focusOn)
{
  GingaScreenID screenId;
...
Color *
FormatterRegion::getBackgroundColor ()
{
  return bgColor;
}

void
FormatterRegion::barWipe (Transition *transition, bool isShowEffect)
{
...
void *
FormatterRegion::barWipeT (void *ptr)
{
  TransInfo *trans;
  Transition *t;
  FormatterRegion *fr;
...
void
FormatterRegion::fade (Transition *transition, bool isShowEffect)
{
  int i, factor = 1;
...
void *
FormatterRegion::fadeT (void *ptr)
{
  TransInfo *trans;
  Transition *t;
  FormatterRegion *fr;
...
void
FormatterRegion::lock ()
{
  Thread::mutexLock (&mutex);
}

void
FormatterRegion::unlock ()
{
  Thread::mutexUnlock (&mutex);
}

void
FormatterRegion::lockTransition ()
{
  Thread::mutexLock (&mutexT);
}

void
FormatterRegion::unlockTransition ()
{
  Thread::mutexUnlock (&mutexT);
}

void
FormatterRegion::lockFocusInfo ()
{
  Thread::mutexLock (&mutexFI);
}

void
FormatterRegion::unlockFocusInfo ()
{
  Thread::mutexUnlock (&mutexFI);
}

void
FormatterRegion::setTransparency (string strTrans)
{
  float trans;
  if (strTrans == "")
    {
...
float
FormatterRegion::getTransparency ()
{
  return this->transparency;
}

void
FormatterRegion::setTransparency (float transparency)
{
  lock ();
  if (transparency < 0.0)
    {
...
void
FormatterRegion::setBackgroundColor (string color)
{
  Color *bg = NULL;
...
void
FormatterRegion::setBackgroundColor (Color *color)
{
  lockFocusInfo ();
...
void
FormatterRegion::setChromaKey (string value)
{
  if (value != "")
    {
      if (value == "black")
...
void
FormatterRegion::setRgbChromaKey (string value)
{
  if (value != "")
    {
...
void
FormatterRegion::setFit (string value)
{
  if (value != "")
    {
...
void
FormatterRegion::setFit (short value)
{
  if (value < 0)
    {
...
void
FormatterRegion::setScroll (string value)
{
  if (value != "")
    {
...
void
FormatterRegion::setScroll (short value)
{
  if (value < 0)
    {
