...
#define BR_PUCRIO_TELEMIDIA_GINGA_CORE_MB_END\
  NS_END6
...
#define BR_PUCRIO_TELEMIDIA_GINGA_CORE_PLAYER_BEGIN\
  NS_BEGIN6 (br, pucrio, telemidia, ginga, core, player)

#define BR_PUCRIO_TELEMIDIA_GINGA_CORE_PLAYER_END\
  NS_END6
