 ...
 */
int
NTPDatagram::convertNTPDataToHost (alt_u8 *buffer)
{
  ...
  *NTP_DATA_GRAM_REF_ID (buffer) = ntohl (*NTP_DATA_GRAM_REF_ID (buffer));
 ...
 */
int
NTPDatagram::convertNTPDataToNet (alt_u8 *buffer)
{
  *NTP_DATA_GRAM_CONTROL_HEADER (buffer)
  ...
  *NTP_DATA_GRAM_REF_ID (buffer) = htonl (*NTP_DATA_GRAM_REF_ID (buffer));
...
void
NTPDatagram::setLeapIndicator (alt_u8 li)
{
  leap_indicator = li;
}

void
NTPDatagram::setVersionNumber (alt_u8 vn)
{
  version_number = vn;
}

void
NTPDatagram::setMode (alt_u8 m)
{
  mode = m;
}

void
NTPDatagram::setStratum (alt_u8 s)
{
  stratum = s;
}

void
NTPDatagram::setPoll_interval (alt_8 pi)
{
  poll_interval = pi;
}

void
NTPDatagram::setPrecision (alt_8 p)
{
  precision = p;
}

void
NTPDatagram::setRootDelay (alt_32 rd)
{
  root_delay = rd;
}

void
NTPDatagram::setRootDispersion (alt_u32 rd)
{
  root_dispersion = rd;
};
void
NTPDatagram::setRefId (alt_u32 id)
{
  ref_id = id;
}

void
NTPDatagram::setRefTimestamp1 (alt_u32 rt1)
{
  ref_timestamp1 = rt1;
}

void
NTPDatagram::setRefTimestamp2 (alt_u32 rt2)
{
  ref_timestamp2 = rt2;
}

void
NTPDatagram::setOrigTimestamp1 (alt_u32 ot1)
{
  orig_timestamp1 = ot1;
}

void
NTPDatagram::setOrigTimestamp2 (alt_u32 ot2)
{
  orig_timestamp2 = ot2;
}

void
NTPDatagram::setRecvTimestamp1 (alt_u32 rt1)
{
  recv_timestamp1 = rt1;
}

void
NTPDatagram::setRecvTimestamp2 (alt_u32 rt2)
{
  recv_timestamp2 = rt2;
}

void
NTPDatagram::setTransTimestamp1 (alt_u32 tt1)
{
  trans_timestamp1 = tt1;
}

void
NTPDatagram::setTransTimestamp2 (alt_u32 tt2)
{
  trans_timestamp2 = tt2;
}

void
NTPDatagram::setKeyId (alt_u32 id)
{
  key_id = id;
}

void
NTPDatagram::setMsgDigest1 (alt_u32 md1)
{
  msg_digest1 = md1;
}

void
NTPDatagram::setMsgDigest2 (alt_u32 md2)
{
  msg_digest2 = md2;
}

void
NTPDatagram::setMsgDigest3 (alt_u32 md3)
{
  msg_digest3 = md3;
}

void
NTPDatagram::setMsgDigest4 (alt_u32 md4)
{
  msg_digest4 = md4;
}

alt_u8
NTPDatagram::getLeapIndicator ()
{
  return leap_indicator;
}

alt_u8
NTPDatagram::getVersionNumber ()
{
...
alt_u8
NTPDatagram::getStratum ()
{
  return stratum;
}

alt_8
NTPDatagram::getPollInterval ()
{
  return poll_interval;
}

alt_8
NTPDatagram::getPrecision ()
{
  return precision;
}

alt_32
NTPDatagram::getRootDelay ()
{
  return root_delay;
}

alt_u32
NTPDatagram::getRootDispersion ()
{
  return root_dispersion;
}

alt_u32
NTPDatagram::getRefId ()
{
  return ref_id;
}

alt_u32
NTPDatagram::getRefTimestamp1 ()
{
  return ref_timestamp1;
}

alt_u32
NTPDatagram::getRefTimestamp2 ()
{
  return ref_timestamp2;
}

alt_u32
NTPDatagram::getOrigTimestamp1 ()
{
  return orig_timestamp1;
}

alt_u32
NTPDatagram::getOrigTimestamp2 ()
{
  return orig_timestamp2;
}

alt_u32
NTPDatagram::getRecvTimestamp1 ()
{
  return recv_timestamp1;
}

alt_u32
NTPDatagram::getRecvTimestamp2 ()
{
  return recv_timestamp2;
}

alt_u32
NTPDatagram::getTransTimestamp1 ()
{
  return trans_timestamp1;
}

alt_u32
NTPDatagram::getTransTimestamp2 ()
{
  return trans_timestamp2;
}

alt_u32
NTPDatagram::getKeyId ()
{
  return key_id;
}

alt_u32
NTPDatagram::getMsgDigest1 ()
{
  return msg_digest1;
}

alt_u32
NTPDatagram::getMsgDigest2 ()
{
  return msg_digest2;
}

alt_u32
NTPDatagram::getMsgDigest3 ()
{
  return msg_digest3;
}

alt_u32
NTPDatagram::getMsgDigest4 ()
{
  return msg_digest4;
}

int
NTPDatagram::getStream (char **buffer)
{
  if (*buffer == NULL)
    return 0;
  *buffer = (char *)stream;
...
struct tm *
NTPDatagram::ntp2unix (u_long ntp)
{
  time_t t, curr;
  struct tm *tm;
  ...
  for (epoch_nr = 0; epoch_nr < MAX_EPOCH_NR; epoch_nr++)
    {
      ...
      if (1900 + tm->tm_year > curr_year - 68)
        break;
