...
#ifndef CCTRPINTERACTIVECHANNEL_H_
#define CCTRPINTERACTIVECHANNEL_H_

#include "../IInteractiveChannel.h"

#include "CCRTPClient.h"
...
namespace ic {
	class CCRTPInteractiveChannel : public IInteractiveChannel {
		...
		public:
			...
			virtual ~CCRTPInteractiveChannel();

		private:
			CCRTPClient* createClient();
...
#endif /* CCTRPINTERACTIVECHANNEL_H_ */
