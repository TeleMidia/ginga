...
void bin(unsigned short v, int number[], int size) {
  for(; size-1 >= 0; size--) 
...
main (void)
{
  ...
  short dataToSend [] = { 1, 7, 5, 4, 19, 1}; // highest number should be 2^13-1 = 4095
  ...
  for (int i = 0; i < sizeof(dataToSend)/sizeof(dataToSend[0]); i++)
  {
    ...
    if (number[0]) m1->setProperty ("volume", "0.5"); else  m1->setProperty ("volume", "0");
    if (number[1]) m2->setProperty ("volume", "0.5"); else  m2->setProperty ("volume", "0");
    if (number[2]) m3->setProperty ("volume", "0.5"); else  m3->setProperty ("volume", "0");
    if (number[3]) m4->setProperty ("volume", "0.5"); else  m4->setProperty ("volume", "0");
    if (number[4]) m5->setProperty ("volume", "0.5"); else  m5->setProperty ("volume", "0");
    if (number[5]) m6->setProperty ("volume", "0.5"); else  m6->setProperty ("volume", "0");
    if (number[6]) m7->setProperty ("volume", "0.5"); else  m7->setProperty ("volume", "0");
    if (number[7]) m8->setProperty ("volume", "0.5"); else  m8->setProperty ("volume", "0");
    if (number[8]) m9->setProperty ("volume", "0.5"); else  m9->setProperty ("volume", "0");
    if (number[9]) m10->setProperty ("volume", "0.5"); else  m10->setProperty ("volume", "0");
    if (number[10]) m11->setProperty ("volume", "0.5"); else  m11->setProperty ("volume", "0");
    if (number[11]) m12->setProperty ("volume", "0.5"); else  m12->setProperty ("volume", "0");
    // if (number[13]) m13->setProperty ("volume", "0.5"); else  m13->setProperty ("volume", "0");
