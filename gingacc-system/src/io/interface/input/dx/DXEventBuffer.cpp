...
#include "system/io/interface/input/dx/DXEventBuffer.h"
#include "system/io/interface/input/dx/DXInputEvent.h"
#include "system/io/interface/device/dx/DXDeviceScreen.h"
...
namespace io {
	...
	void DXEventBuffer::initDirectInput(){
		...
		pD3dDev = (LPDIRECT3DDEVICE9)(LocalDeviceManager::getInstance())->getGfxRoot(0);
		...
		m_scrHeight = (LocalDeviceManager::getInstance())->getDeviceHeight(); 
