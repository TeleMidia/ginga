...
namespace io {
	...
	void Matrix::multiply (matrix_t* result, const matrix_t* a, const matrix_t* b) {
		matrix_t r;
	...
	void Matrix::init (matrix_t* matrix,
			   double xx, double yx,
			   double xy, double yy,
			   double x0, double y0) {
	...
	void Matrix::setMatrix(const matrix_t* cairo, IDirectFBSurface* primary) {
		s32 matrix[9];
