...
namespace io {
	...
	class Matrix {
		...
		public:			
			...
			static void multiply(matrix_t* result, const matrix_t* a, const matrix_t* b);
			static void init(matrix_t* matrix, double xx, double yx,
						                 double xy, double yy,
		   						 double x0, double y0);
			...
			static void setMatrix(const matrix_t* cairo,  IDirectFBSurface* primary);
