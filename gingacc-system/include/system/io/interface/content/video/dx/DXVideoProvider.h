...
#ifndef DXVIDEOPROVIDER_H_
#define DXVIDEOPROVIDER_H_
...
namespace system {
namespace io {
	class DXVideoProvider : public IContinuousMediaProvider {
		protected:
			//eVMR3*                            vmr;
          std::auto_ptr<VideoGraph>		  m_pVideo;
