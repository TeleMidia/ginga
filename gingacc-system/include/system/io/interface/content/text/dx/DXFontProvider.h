...
#ifndef DXFONTPROVIDER_H_
#define DXFONTPROVIDER_H_


#include "../IFontProvider.h"
#include "../../../output/ISurface.h"

#include "../../../output/dx/DX2DSurface.h"
...
namespace system {
namespace io {
	class DXFontProvider  : public IFontProvider {
		protected:
			LPD3DXFONT font;
			LPDIRECT3DTEXTURE9 fontTex;
			/*string lastText;*/
			static set<LPD3DXFONT>* pool;
